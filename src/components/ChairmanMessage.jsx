...
import "./ChairmanMessage.css"; // optional CSS for styling
...
const ChairmanMessage = () => {
  return (
    <div className="chairman-message-container">
      ...
      <p>
        We look forward to your participation in STS-V 2025 and we will make effort to ensure you have
        a pleasant and fruitful stay in Bengaluru.
      </p>

    

<p>
  Prof. S. Subramanian<br />
  Chair, Organizing Committee, STIS-V
</p>
    </div>
  );
};
