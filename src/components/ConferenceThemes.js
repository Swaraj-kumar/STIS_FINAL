...
const ConferenceThemes = () => {
    return (
        <div className="conference-themes-container">
            <div className="heading-image-conf">
                <h1 className="themes-heading">Conference Themes</h1>
            </div>
            <p className="intro-paragraph">
                Iron and steelmaking sectors are growing globally and notably in Asia. Since the last two decades, world production of steel has grown by almost 50%. Advances in the technology have contributed to improvements in productivity, quality, cost-effectiveness, and environmental friendliness. Further, advances in the theoretical aspects of iron and steelmaking have contributed to technological advances significantly through research, development, design, and process control. In India also these sectors are growing rapidly. This has given a fillip to organize an international conference in India. This conference will highlight Science & Technology of ironmaking and steelmaking. Papers on technology illustrating the application of theory would also be welcomed. It is anticipated that the conference will provide significant benefits for the future iron and steel research and its application to industry and provide a road map for the future.
            </p>

            <h2 className="themes-subheading">Conference Topics</h2>
