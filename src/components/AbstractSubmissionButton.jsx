...
// AbstractSubmission Status is original till now
...
//       if (response.ok) {
//         setMessage("Abstract submitted successfully!");
//         // In future if anyone want to see their abstract submission status then enable this route
//         // setTimeout(() => navigate("/AbstractSubmissionStatus"), 1000); 
//       } else {
//         setMessage(`Error: ${data.message}`);
//       }
//     } catch (error) {
