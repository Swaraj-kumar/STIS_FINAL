...
const Bengaluru = () => {
    ...
    const renderContent = () => {
        const categoryContent = content[activeTab];
        if (!categoryContent) return <p>Content coming soon...</p>;
    ...
    return (
        <div className="bengaluru-container">
            <div className="bengaluru-header">
                <h1>Explore Bengaluru</h1>
                <p>Discover the Garden City of India</p>
            </div>

            <nav className="bengaluru-navigation">
            ...
            <main className="content-section">
                ...
                <div className="attribution">
                    <p>
                        ...
                        <a
                            href="https://bengaluruurban.nic.in/en/tourism/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            Bengaluru Urban District Official Website
                        </a>
                    </p>
                </div>
            </main>
